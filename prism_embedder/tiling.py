...
from prism_embedder.utils import load_csv, fix_random_seeds
from prism_embedder.utils.config import get_cfg_from_file
from prism_embedder.wsi import extract_coordinates, save_coordinates, visualize_coordinates
...
def main(args):
    ...
    if process_list.is_file() and cfg.resume:
        ...
        data = {
            ...
            "embedding_status": ["tbp"] * len(wsi_paths),
            "aggregation_status": ["tbp"] * len(wsi_paths),
